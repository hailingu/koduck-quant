...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/duck-flow/duck-flow)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](./LICENSE)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.8-blue.svg)](https://www.typescriptlang.org/)
[![Status](https://img.shields.io/badge/status-production--ready-brightgreen.svg)](https://github.com/duck-flow/duck-flow)

Duck Flow 是一个功能强大、类型安全的流程管理和实体渲染框架，提供完整的依赖注入、多租户隔离和生命周期管理能力。
...
\`\`\`typescript
import { createDuckFlowRuntime } from 'duck-flow';
...
\`\`\`tsx
import { DuckFlowProvider, useDuckFlowRuntime } from 'duck-flow';

function App() {
return (
<DuckFlowProvider environment="production">
<MyComponent />
</DuckFlowProvider>
);
}
...
Runtime 是 Duck Flow 的核心，管理所有组件的生命周期：
...
\`\`\`typescript
import { setMetricsProvider } from 'duck-flow';
...
beforeEach(() => {
runtime = createDuckFlowRuntime({ environment: 'test' });
});
...
- [问题追踪](https://github.com/duck-flow/duck-flow/issues)
- [讨论区](https://github.com/duck-flow/duck-flow/discussions)

## 💬 获取帮助

- 📖 [文档](./docs/)
- 🐛 [Issues](https://github.com/duck-flow/duck-flow/issues)

---

**使用 Duck Flow 构建出色的应用！** 🦆
