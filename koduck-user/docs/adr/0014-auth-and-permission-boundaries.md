...
- **日期**: 2026-04-09
- **作者**: @hailingu
- **相关**: #701, koduck-user/docs/implementation/koduck-user-service-tasks.md Task 6.2, ADR-0013
...
- [koduck-auth-user-service-design.md](../design/koduck-auth-user-service-design.md) 4.1 / 8.3 节
